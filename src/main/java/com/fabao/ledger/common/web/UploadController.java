...
public class UploadController {
	...
	/**
		...
		public void file_upload(HttpServletRequest request, HttpServletResponse response) throws Exception{
			  	...
			  	//文件保存的路径
		        String savePath = application.getRealPath("/")+Global.getConfig("sysnotice.image.path");
		        // 文件保存目录URL
		        String saveUrl = request.getContextPath() +Global.getConfig("sysnotice.image.path");
