...
@Controller
@RequestMapping("/tb/qccategory")
public class QcCategoryController extends BaseController {
	private static final Logger log = Logger.getLogger(QcCategoryController.class);
	@Autowired
	...
	public String qccategoryList(Model model){
		...
		return "modules/tb/qccategory/qccategory-list";
	}
	/**
	 * 质检分类列表数据获取
	 * @param page
