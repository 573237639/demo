...
<script type="text/javascript">
	//点击保存追加记录
	function addRecords(){
		$("#ledgerId").val($("input[name='tbLedger.id']").val());
		...
		$('#tbSupplementForm').form('submit', {    
			url:"${ctx}/tb/ledger/addTbSupplementData", 
	...
	$("#recordadd-datagrid").datagrid({
	    ...
	    columns:[[
  		...
  		loader:function(param,success,error){ 
  			param.id = $("input[name='tbLedger.id']").val();
	    	$.ajax({
	            url:"${ctx}/tb/ledger/recordDataGrid",
	            checkbox: "true", 
	            data:param,
	            type:"post",
	            dataType:"json",
...
<br/>
	<div class="div_margin_left" >
		<form id="tbSupplementForm" method="post"  action="" >
				...
				<input class="easyui-textbox "  id="vacSupplementContent" name="vacSupplementContent"  data-options="multiline:true"  style="width:600px" validType="length[0,2000]" >
				<br/>
				<br/>
				<permission:hasPermission action="tb/ledger/recordDataGrid">				
