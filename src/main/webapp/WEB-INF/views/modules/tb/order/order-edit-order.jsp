...
var statusTypeList = ${statusTypeList};
	var loadGrid = function() {
		...
		$("#ordereditorder-datagrid").datagrid({
			striped:true,
	  		checkOnSelect:true ,
	  		singleSelect:true,
	  		fitColumns:true,
  		...
  		loader:function(param,success,error){
  			param.vacOrderBusinessType = $("#vacOrderBusinessType_order").combobox("getValue");
  			param.numOrderStatus = $("#numOrderStatus_order").textbox("getValue");
  			param.vacOrderNumber = $("#vacOrderNumber").val();
	    	$.ajax({
	            url:"${ctx}/tb/order/hisorder-datagrid",
	            checkbox: "true", 
	            data:param,
	            type:"post",
	            dataType:"json",
...
<script type="text/javascript">
	...
	function submitForm() {
		...
		$("#ordereditorder-datagrid").datagrid('load');
...
<br/>
		<form id="editorder-from" method="post" action=""  modelAttribute="tbOrders">
				<div >
					...
					<input class="easyui-combotree"  style="width:300px;height:28px;" id="vacOrderBusinessType_order" name="vacOrderBusinessType" editable="false"
					...
					<input class="easyui-combobox combobox_input" id="numOrderStatus_order"　name="numOrderStatus"  editable="false"   style="width:100px;height:28px;"
		...
		<br/>
		<div class="view">
		<table class="easyui-datagrid" id="ordereditorder-datagrid" 	style="width: 100%;" pagination="true">
		</table>
		</div>
		<div class="datanull" style="display: none;text-align:center;">
			暂无结果
		</div>
	</div>
