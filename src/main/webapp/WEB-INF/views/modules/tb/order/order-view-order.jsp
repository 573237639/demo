	...
	var loadGrid = function() {
		...
		$("#ordervieworder-datagrid").datagrid({
  		...
  		loader:function(param,success,error){
  			param.vacOrderBusinessType = $("#vacOrderBusinessType_view").combobox("getValue");
	    	...
	    	$.ajax({
	            ...
	            success: function(data){
	            	if(data.total == 0){
	            		$(".order_order_view").hide();
	            		$(".order_order_datanull").show();
	            	}else{
	            		$(".order_order_view").show();
	            		$(".order_order_datanull").hide();
	            	}
	                success(data);
	            }
	        })
...
<br/>
		<form id="editorder-from" method="post" action=""  modelAttribute="tbOrders">
				<div >
					...
					<input class="easyui-combotree"  style="width:300px;height:28px;" id="vacOrderBusinessType_view" name="vacOrderBusinessType" editable="false"
		...
		<br/>
				...
				<div class="order_order_view">
		<table class="easyui-datagrid" id="ordervieworder-datagrid" 	style="width: 100%;" pagination="true">
		</table>
			</div>
			<div class="order_order_datanull" style="display: none;text-align:center;">
				暂无结果
			</div>	
	</div>
