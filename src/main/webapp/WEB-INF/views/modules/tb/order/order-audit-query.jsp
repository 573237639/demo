...
$(function() {  	
	  ...
	  $('#numOrderReceiveCityId').combobox({ 
		...
		<form id="tbOrdersListForm" method="post" action="${ctf}/tb/order/orderList"  modelAttribute="tbClients,tbOrders">
				<input type="hidden" id="page" name="page">
				<input type="hidden" id="rows" name="rows">
				<input type="hidden" id="numOrderStatus" name="numOrderStatus">
				<br/>
				<div>	
					 <span>工单产生时间</span>
